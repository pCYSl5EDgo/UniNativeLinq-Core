...
namespace CecilRewrite
{
    ...
    static class JoinDefaultEqualityComparerRefFuncHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace,
                nameof(JoinDefaultEqualityComparerRefFuncHelper),
        ...
        private static void JoinOuter(TypeDefinition @static, TypeDefinition type, string prefix, Func<IEnumerable<TypeReference>, TypeReference> InputFunc, MethodDefinition constructor)
        {
            ...
            Epilogue(method, MainModule, Element0, Element1, T, Enumerable0, Enumerator0, Enumerable1, Enumerator1, TKey, TKeySelector0, TKeySelectorFunc0, TKeySelector1, TKeySelectorFunc1, DefaultTKeyEqualityComparer, out var @return, out var selector, out var allocator, out var TSelector);
        ...
        private static void Epilogue(MethodDefinition method, ModuleDefinition MainModule, TypeReference Element0, TypeReference Element1, GenericParameter T, GenericInstanceType Enumerable0, TypeReference Enumerator0, GenericInstanceType Enumerable1, TypeReference Enumerator1, GenericParameter TKey, TypeReference TKeySelector0, TypeReference TKeySelectorFunc0, TypeReference TKeySelector1, TypeReference TKeySelectorFunc1, GenericInstanceType DefaultTKeyEqualityComparer, out GenericInstanceType @return, out ParameterDefinition selector, out ParameterDefinition allocator, out GenericInstanceType TSelector)
        {
            ...
            TSelector = MainModule.GetType(NameSpace, "DelegateRefFuncToStructOperatorFunc`3").MakeGenericInstanceType(SelectorTuple3);
            var TSelectorFunc = MainModule.GetType(NameSpace, "RefFunc`3").MakeGenericInstanceType(SelectorTuple3);
        ...
        private static void InternalRoutine(GenericParameter TKey, TypeReference Element, out TypeReference TKeySelector, out GenericInstanceType TKeySelectorFunc)
        {
            ...
            TKeySelector = MainModule.GetType(NameSpace, "DelegateRefFuncToStructOperatorFunc`2").MakeGenericInstanceType(typeReferences);
            TKeySelectorFunc = MainModule.GetType(NameSpace, "RefFunc`2").MakeGenericInstanceType(typeReferences);
        }
    }
}
