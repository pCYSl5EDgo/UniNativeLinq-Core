...
namespace CecilRewrite
{
    ...
    static class JoinOperatorHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace,
                nameof(JoinOperatorHelper),
        ...
        {
            var method = Prologue(@static, out var MainModule, out var TKey, out var TKeyEqualityComparer, out var T, out var IRefFunc2);
            ...
            Epilogue(method, MainModule, Element0, Element1, T, Enumerable0, Enumerator0, Enumerable1, Enumerator1, TKey, TKeySelector0, TKeySelector1, TKeyEqualityComparer, out var @return, out var comparer, out var selector, out var allocator);
        ...
        private static void Epilogue(MethodDefinition method, ModuleDefinition MainModule,
            ...
            TypeReference Enumerator0, GenericInstanceType Enumerable1, TypeReference Enumerator1, GenericParameter TKey,
            GenericParameter TKeySelector0, GenericParameter TKeySelector1, TypeReference TKeyEqualityComparer,
            out GenericInstanceType @return, out ParameterDefinition comparer, out ParameterDefinition selector,
            out ParameterDefinition allocator)
        {
            ...
            comparer = new ParameterDefinition("comparer", ParameterAttributes.In, TKeyEqualityComparer.MakeByReferenceType());
        ...
        private static MethodDefinition Prologue(TypeDefinition @static, out ModuleDefinition MainModule, out GenericParameter TKey, out TypeReference TKeyEqualityComparer, out GenericParameter T, out TypeDefinition IRefFunc2)
        {
            ...
            var _TKeyEqualityComparer = new GenericParameter(nameof(TKeyEqualityComparer), method) { HasNotNullableValueTypeConstraint = true };
            _TKeyEqualityComparer.Constraints.Add(MainModule.GetType(NameSpace, "IRefFunc`3").MakeGenericInstanceType(new[]
            {
                TKey,
                TKey,
                MainModule.TypeSystem.Boolean,
            }));
            TKeyEqualityComparer = _TKeyEqualityComparer;
            method.GenericParameters.Add(_TKeyEqualityComparer);
