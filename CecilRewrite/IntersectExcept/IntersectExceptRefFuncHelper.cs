...
namespace CecilRewrite
{
    ...
    static class IntersectExceptRefFuncHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            TypeDefinition IntersectRefFuncHelper = new TypeDefinition(NameSpace,
                nameof(IntersectRefFuncHelper),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
            IntersectRefFuncHelper.CustomAttributes.Add(ExtensionAttribute);
            module.Types.Add(IntersectRefFuncHelper);

            TypeDefinition ExceptRefFuncHelper = new TypeDefinition(NameSpace,
                nameof(ExceptRefFuncHelper),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
            ExceptRefFuncHelper.CustomAttributes.Add(ExtensionAttribute);
            module.Types.Add(ExceptRefFuncHelper);
            ...
            {
                Make(IntersectRefFuncHelper, type0, "Array", 0, CalcArrayType, AsRefEnumerableArray, nameof(Intersect), Intersect);
                Make(IntersectRefFuncHelper, type0, "Array", 1, CalcArrayType, AsRefEnumerableArray, nameof(Intersect), Intersect);
                Make(ExceptRefFuncHelper, type0, "Native", 0, NativeArray.MakeGenericInstanceType, AsRefEnumerableNative, nameof(Except), Except);
                Make(ExceptRefFuncHelper, type0, "Native", 1, NativeArray.MakeGenericInstanceType, AsRefEnumerableNative, nameof(Except), Except);
                foreach (var type1 in Enumerables)
                {
                    Make(IntersectRefFuncHelper, type0, type1, nameof(Intersect), Intersect);
                    Make(ExceptRefFuncHelper, type0, type1, nameof(Except), Except);
                }
            }
        }
        ...
        private static void Make(TypeDefinition @static, TypeDefinition type, string prefix, int index, Func<IEnumerable<TypeReference>, TypeReference> InputFunc, MethodReference constructor, string name, TypeDefinition operation)
        {
            ...
            var Func = MainModule.GetType(NameSpace, "RefFunc`3").MakeGenericInstanceType(FuncGenericArguments);
            var TComparer = MainModule.GetType(NameSpace, "DelegateRefFuncToStructOperatorFunc`3").MakeGenericInstanceType(FuncGenericArguments);
        ...
        private static void Make(TypeDefinition @static, TypeDefinition type0, TypeDefinition type1, string name, TypeDefinition operation)
        {
            ...
            var Func = MainModule.GetType(NameSpace, "RefFunc`3").MakeGenericInstanceType(new[]
            {
                Element0,
                Element0,
                MainModule.TypeSystem.Int32,
            });
            var TComparer = MainModule.GetType(NameSpace, "DelegateRefFuncToStructOperatorFunc`3").MakeGenericInstanceType(new[]
            {
                Element0,
                Element0,
                MainModule.TypeSystem.Int32,
