...
namespace CecilRewrite
{
    ...
    static class ContainsRefFuncHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace, nameof(ContainsRefFuncHelper), StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
        ...
        private static void Contains(TypeDefinition @static, TypeDefinition type)
        {
            ...
            var Func3 = MainModule.GetType(NameSpace, "RefFunc`3").MakeGenericInstanceType(new[] { Element, Element, Boolean });
