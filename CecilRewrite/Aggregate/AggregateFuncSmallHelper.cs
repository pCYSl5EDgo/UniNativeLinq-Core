...
namespace CecilRewrite
{
    ...
    static class AggregateFuncSmallHelper
    {
        private const string NameSpace = "UniNativeLinq";

        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace, nameof(AggregateFuncSmallHelper), StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
