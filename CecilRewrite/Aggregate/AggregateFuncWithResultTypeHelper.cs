...
namespace CecilRewrite
{
    ...
    static class AggregateFuncWithResultTypeHelper
    {
        private const string NameSpace = "UniNativeLinq";

        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace, nameof(AggregateFuncWithResultTypeHelper), StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
