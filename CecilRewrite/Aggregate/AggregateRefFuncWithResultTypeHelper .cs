...
namespace CecilRewrite
{
    ...
    static class AggregateRefFuncWithResultTypeHelper
    {
        private const string NameSpace = "UniNativeLinq";

        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace, nameof(AggregateRefFuncWithResultTypeHelper), StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
        ...
        static void Aggregate(this TypeDefinition @static, TypeDefinition type)
        {
            ...
            var TFunc0 = MainModule.GetType(NameSpace, "RefFunc`3").MakeGenericInstanceType(TAccumulate0, Element, TAccumulate0);
            var TResultFunc0 = MainModule.GetType(NameSpace, "RefFunc`2").MakeGenericInstanceType(TAccumulate0, TResult0);
