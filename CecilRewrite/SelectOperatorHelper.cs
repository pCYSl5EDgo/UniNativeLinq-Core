...
namespace CecilRewrite
{
    ...
    static class SelectOperatorHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace,
                nameof(SelectOperatorHelper),
        ...
        private static void Select(TypeDefinition @static, TypeDefinition type)
        {
            ...
            TAction.Constraints.Add(MainModule.GetType(NameSpace, "IRefAction`2").MakeGenericInstanceType(new[]
            {
                Element,
                T,
            }));
