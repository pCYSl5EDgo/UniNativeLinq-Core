...
namespace CecilRewrite
{
    ...
    static class SelectManyRefFuncHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace,
                nameof(SelectManyRefFuncHelper),
        ...
        private static void SelectManyCommon(TypeDefinition @static, TypeDefinition type, string name, Func<GenericParameter, TypeReference> thisFunc, Func<MethodDefinition, bool> predicate)
        {
            ...
            var Func = MainModule.GetType(NameSpace, "RefAction`2").MakeGenericInstanceType(new TypeReference[]
            {
                T,
                TEnumerable0
            });
            ...
            var TAction = MainModule.GetType(NameSpace, "DelegateRefActionToStructOperatorAction`2").MakeGenericInstanceType(new TypeReference[]
            {
                T,
                TEnumerable0
            });
