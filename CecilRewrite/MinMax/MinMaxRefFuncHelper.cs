...
namespace CecilRewrite
{
    ...
    static class MinMaxRefFuncHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            TypeDefinition Int32;
            Int32 = new TypeDefinition(NameSpace,
                nameof(MinMaxRefFuncHelper) + nameof(Int32),
            ...
            Double = new TypeDefinition(NameSpace,
                nameof(MinMaxRefFuncHelper) + nameof(Double),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
            ...
            Single = new TypeDefinition(NameSpace,
                nameof(MinMaxRefFuncHelper) + nameof(Single),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
            ...
            UInt64 = new TypeDefinition(NameSpace,
                nameof(MinMaxRefFuncHelper) + nameof(UInt64),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
            ...
            UInt32 = new TypeDefinition(NameSpace,
                nameof(MinMaxRefFuncHelper) + nameof(UInt32),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
            ...
            Int64 = new TypeDefinition(NameSpace,
                nameof(MinMaxRefFuncHelper) + nameof(Int64),
                StaticExtensionClassTypeAttributes, module.TypeSystem.Object);
        ...
        private static void MinMax(TypeDefinition @static, TypeDefinition type, TypeReference number, string name)
        {
            ...
            var Func = MainModule.GetType(NameSpace, "RefFunc`2").MakeGenericInstanceType(new[]
            {
                Element,
                number,
            });

            var Operator = MainModule.GetType(NameSpace, "DelegateRefFuncToStructOperatorFunc`2").MakeGenericInstanceType(new[]
            {
                Element,
                number
            });
            ...
            method.Body.Variables.Add(new VariableDefinition(Operator));

            var processor = method.Body.GetILProcessor();
            processor.Do(OpCodes.Ldarg_0);
            processor.Do(OpCodes.Ldarg_1);
            processor.NewObj(Operator.FindMethod(".ctor"));
