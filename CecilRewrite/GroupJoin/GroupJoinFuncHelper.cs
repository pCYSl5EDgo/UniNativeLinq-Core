...
namespace CecilRewrite
{
    ...
    static class GroupJoinFuncHelper
    {
        ...
        private static void GroupJoin(TypeDefinition @static, TypeDefinition type0, TypeDefinition type1)
        {
            ...
            var TKeyEqualityComparerFunc = MainModule.ImportReference(SystemModule.GetType("System", "Func`3")).MakeGenericInstanceType(Tuple3Predicate);
            var TKeyEqualityComparer = MainModule.GetType(NameSpace, "DelegateFuncToStructOperatorFunc`3").MakeGenericInstanceType(Tuple3Predicate);
            ...
            method.Body.Variables.Add(new VariableDefinition(TKeyEqualityComparer));
