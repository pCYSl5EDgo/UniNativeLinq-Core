...
namespace CecilRewrite
{
    ...
    static class GroupJoinFuncHelper
    {
        internal static void Create(ModuleDefinition module)
        {
            var @static = new TypeDefinition(NameSpace,
                nameof(GroupJoinFuncHelper),
        ...
        {
            var MainModule = Prologue(@static, out var method, out var TKey, out var T);
            ...
            var Enumerable1 = InnerRoutine(type, method, TKey, MainModule, out var Enumerator1, out var Element1, out var TInnerKeySelectorFunc, out var TInnerKeySelector, out var TKeyEqualityComparerFunc, out var TKeyEqualityComparer, out var WhereIndexEnumerable);

            var TSelectorFunc = Epilogue(Element0, WhereIndexEnumerable, T, MainModule, Enumerable0, Enumerator0, Enumerable1, Enumerator1, Element1, TKey, TOuterKeySelector, TInnerKeySelector, TKeyEqualityComparer, method, out var TSelector, out var @return);
        ...
        private static void GroupJoinInner(TypeDefinition @static, TypeDefinition type, string prefix, Func<IEnumerable<TypeReference>, TypeReference> InputFunc, MethodDefinition constructor)
        {
            ...
            var TInnerKeySelectorFunc = InternalInnerRoutine(Element1, TKey, MainModule, out var TInnerKeySelector, out var TKeyEqualityComparerFunc, out var TKeyEqualityComparer, out var WhereIndexEnumerable);
        ...
        private static void GroupJoin(TypeDefinition @static, TypeDefinition type0, TypeDefinition type1)
        {
            ...
            var Enumerable1 = InnerRoutine(type1, method, TKey, MainModule, out var Enumerator1, out var Element1, out var TInnerKeySelectorFunc, out var TInnerKeySelector, out var TKeyEqualityComparerFunc, out var TKeyEqualityComparer, out var WhereIndexEnumerable);
            ...
            var comparer = DefineParameters(TOuterKeySelectorFunc, method, TInnerKeySelectorFunc, TKeyEqualityComparerFunc, TSelectorFunc, out var selector, out var allocator);
        ...
        private static GenericInstanceType InnerRoutine(TypeDefinition type1, MethodDefinition method, GenericParameter TKey, ModuleDefinition MainModule, out TypeReference Enumerator1, out TypeReference Element1, out GenericInstanceType TInnerKeySelectorFunc, out GenericInstanceType TInnerKeySelector, out GenericInstanceType TKeyEqualityComparerFunc, out GenericInstanceType TKeyEqualityComparer, out GenericInstanceType WhereIndexEnumerable)
        {
            ...
            TInnerKeySelectorFunc = InternalInnerRoutine(Element1, TKey, MainModule, out TInnerKeySelector, out TKeyEqualityComparerFunc, out TKeyEqualityComparer, out WhereIndexEnumerable);
            return Enumerable1;
        }
        ...
        private static GenericInstanceType InternalInnerRoutine(TypeReference Element1, GenericParameter TKey, ModuleDefinition MainModule, out GenericInstanceType TInnerKeySelector, out GenericInstanceType TKeyEqualityComparerFunc, out GenericInstanceType TKeyEqualityComparer, out GenericInstanceType WhereIndexEnumerable)
        {
            ...
            TInnerKeySelector = MainModule.GetType(NameSpace, "DelegateFuncToStructOperatorFunc`2").MakeGenericInstanceType(Element1_TKey);
            ...
            var Tuple3Predicate = new[]
            {
                TKey,
                TKey,
                MainModule.TypeSystem.Boolean,
            };
            TKeyEqualityComparerFunc = MainModule.ImportReference(SystemModule.GetType("System", "Func`3")).MakeGenericInstanceType(Tuple3Predicate);
            TKeyEqualityComparer = MainModule.GetType(NameSpace, "DelegateFuncToStructOperatorFunc`3").MakeGenericInstanceType(Tuple3Predicate);
        ...
        private static GenericInstanceType InternalOuterRoutine(TypeReference Element0, GenericParameter TKey, ModuleDefinition MainModule, out GenericInstanceType TOuterKeySelector)
        {
            ...
            TOuterKeySelector = MainModule.GetType(NameSpace, "DelegateFuncToStructOperatorFunc`2").MakeGenericInstanceType(Element0_TKey);
            return TOuterKeySelectorFunc;
        }

        private static ModuleDefinition Prologue(TypeDefinition @static, out MethodDefinition method, out GenericParameter TKey, out GenericParameter T)
        {
        ...
        private static GenericInstanceType Epilogue(TypeReference Element0, GenericInstanceType WhereIndexEnumerable, GenericParameter T, ModuleDefinition MainModule, GenericInstanceType Enumerable0, TypeReference Enumerator0, GenericInstanceType Enumerable1, TypeReference Enumerator1, TypeReference Element1, GenericParameter TKey, GenericInstanceType TOuterKeySelector, GenericInstanceType TInnerKeySelector, GenericInstanceType TKeyEqualityComparer, MethodDefinition method, out GenericInstanceType TSelector, out GenericInstanceType @return)
        {
            var Tuple3 = new[]
            {
                Element0,
            ...
            TSelector = MainModule.GetType(NameSpace, "DelegateFuncToStructOperatorFunc`3").MakeGenericInstanceType(Tuple3);
        ...
        private static ParameterDefinition DefineParameters(GenericInstanceType TOuterKeySelectorFunc, MethodDefinition method, GenericInstanceType TInnerKeySelectorFunc, GenericInstanceType TKeyEqualityComparerFunc, GenericInstanceType TSelectorFunc, out ParameterDefinition selector, out ParameterDefinition allocator)
        {
            ...
            var comparer = new ParameterDefinition("comparer", ParameterAttributes.None, TKeyEqualityComparerFunc);
            method.Parameters.Add(comparer);

            selector = new ParameterDefinition("selector", ParameterAttributes.None, TSelectorFunc);
