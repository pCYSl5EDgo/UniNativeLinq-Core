...
namespace UniNativeLinq
{
    ...
    public unsafe struct
        MaxByEnumerableInt64<TEnumerable, TEnumerator, T, TKeySelector>
        : IRefEnumerable<MaxByEnumerableInt64<TEnumerable, TEnumerator, T, TKeySelector>.Enumerator, T>
        where T : unmanaged
        ...
        where TEnumerable : struct, IRefEnumerable<TEnumerator, T>
    {
        ...
        public MaxByEnumerableInt64(in TEnumerable enumerable, in TKeySelector keySelector, Allocator allocator)
        {
