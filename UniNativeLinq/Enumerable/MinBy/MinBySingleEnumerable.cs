...
namespace UniNativeLinq
{
    ...
    public unsafe struct
        MinBySingleEnumerable<TEnumerable, TEnumerator, T, TKeySelector>
        : IRefEnumerable<MinBySingleEnumerable<TEnumerable, TEnumerator, T, TKeySelector>.Enumerator, T>
        where T : unmanaged
        ...
        where TEnumerable : struct, IRefEnumerable<TEnumerator, T>
    {
        ...
        public MinBySingleEnumerable(in TEnumerable enumerable, in TKeySelector keySelector, Allocator allocator)
        {
