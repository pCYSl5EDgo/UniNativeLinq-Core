...
namespace UniNativeLinq
{
    public static unsafe class NativeArrayEnumerable
    {
        ...
        public static
            ...
            where T : unmanaged
            => new OrderByEnumerable<NativeEnumerable<T>, NativeEnumerable<T>.Enumerator, T, OrderByFromFunc<T>>(@this.AsRefEnumerable(), comparer, allocator);
        ...
        public static
            ...
            where T : unmanaged
            => new OrderByEnumerable<NativeEnumerable<T>, NativeEnumerable<T>.Enumerator, T, OrderByDescending<T, OrderByFromFunc<T>>>(@this.AsRefEnumerable(), (OrderByFromFunc<T>)comparer, allocator);
        ...
        public static
            ConcatEnumerable<
                ...
                T
            >
            Concat<T>(this NativeArray<T> @this, in RingBuffer<T> second)
            where T : unmanaged
            => new ConcatEnumerable<
                NativeEnumerable<T>,
                NativeEnumerable<T>.Enumerator,
        ...
        public static
            ConcatEnumerable<
                ...
                T
            >
            Concat<T>(this NativeArray<T> @this, in UnrolledLinkedList<T> second)
            where T : unmanaged
            => new ConcatEnumerable<
                NativeEnumerable<T>,
                NativeEnumerable<T>.Enumerator,
        ...
        public static
            ...
            >
            GroupJoin<
                T0, TKey0, TKeySelector0, TKeySelector1, T1, T0Selector, TEqualityComparer0, T
            >
            (this NativeArray<T> @this,
        ...
        public static bool Contains<T>
            ...
            where T : unmanaged
            => @this.AsRefEnumerable().Contains(in value, EqualityComparer<T>.Default);
        ...
        public static
            ...
            >
            Union<T>
            (this NativeArray<T> @this, in RingBuffer<T>
                second, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            => new DistinctEnumerable<
                ConcatEnumerable<
        ...
        public static
            ...
            >
            Union<T>
            (this NativeArray<T> @this, in UnrolledLinkedList<T>
                second, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            => new DistinctEnumerable<
                ConcatEnumerable<
        ...
        public static
            ...
            >
            Intersect<T>
            (this NativeArray<T> @this, in RingBuffer<T> second, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            => new SetOperationEnumerable<
                NativeEnumerable<T>,
                NativeEnumerable<T>.Enumerator,
        ...
        public static
            ...
            >
            Join<
                T0, TKey0, TKeySelector0, TKeySelector1, T1, T0Selector, T
            >
            (this NativeArray<T> @this, in RingBuffer<T0> inner, in TKeySelector0 outerKeySelector, in TKeySelector1 innerKeySelector, in T0Selector resultSelector, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            where T0 : unmanaged
            where T1 : unmanaged
            where TKey0 : unmanaged
        ...
        public static
            ...
            Join<
                T0, TKey0, TKeySelector0, TKeySelector1, T1, T0Selector, T
            >
            (this NativeArray<T> @this, in UnrolledLinkedList<T0> inner, in TKeySelector0 outerKeySelector, in TKeySelector1 innerKeySelector, in T0Selector resultSelector, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            where T0 : unmanaged
            where T1 : unmanaged
            where TKey0 : unmanaged
        ...
        public static
            ...
            Join<
                T0, TKey0, T1, T
            >
            (this NativeArray<T> @this, in RingBuffer<T0> inner, in DelegateFuncToStructOperatorFunc<T, TKey0> outerKeySelector, in DelegateFuncToStructOperatorFunc<T0, TKey0> innerKeySelector, in Func<T, T0, T1> resultSelector, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            where T0 : unmanaged
            where T1 : unmanaged
            where TKey0 : unmanaged
        ...
        public static
            ...
            Join<
                T0, TKey0, T1, T
            >
            (this NativeArray<T> @this, in UnrolledLinkedList<T0> inner, in DelegateFuncToStructOperatorFunc<T, TKey0> outerKeySelector, in DelegateFuncToStructOperatorFunc<T0, TKey0> innerKeySelector, in Func<T, T0, T1> resultSelector, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            where T0 : unmanaged
            where T1 : unmanaged
            where TKey0 : unmanaged
        ...
        public static
            ...
            >
            Zip<T0, TResult1, T>
            (this NativeArray<T> @this, in RingBuffer<T0>
                second, Func<T, T0, TResult1> action, T firstDefaultValue = default, T0 secondDefaultValue = default, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            where T0 : unmanaged
            where TResult1 : unmanaged
        ...
        public static
            ...
            >
            Zip<T0, TResult1, T>
            (this NativeArray<T> @this, in UnrolledLinkedList<T0>
            second, Func<T, T0, TResult1> action, T firstDefaultValue = default, T0 secondDefaultValue = default, Allocator allocator = Allocator.Temp)
            where T : unmanaged
            where T0 : unmanaged
            where TResult1 : unmanaged
