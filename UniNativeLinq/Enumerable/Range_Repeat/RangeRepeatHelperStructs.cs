...
{
    public struct SingleIncrement : IRangeRepeat<float>
    {
    ...
    public struct DoubleIncrement : IRangeRepeat<double>
    {
    ...
    public struct DecimalIncrement : IRangeRepeat<decimal>
    {
    ...
    public struct Int32Increment : IRangeRepeat<int>
    {
    ...
    public struct Int64Increment : IRangeRepeat<long>
    {
    ...
    public struct UInt64Increment : IRangeRepeat<ulong>
    {
    ...
    public struct UInt32Increment : IRangeRepeat<uint>
    {
    ...
    public struct NoAction<T> : IRangeRepeat<T>
        where T : unmanaged
    {
